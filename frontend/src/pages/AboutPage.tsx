            ...
            <Stack spacing="xl">
                ...
                <SimpleGrid cols={{base: 1, sm: 3}} spacing="md">
                    <Card shadow="sm" padding="lg" radius="md" withBorder>
                        <CheckCircleIcon fontSize="large" className="text-blue-500 mb-4"/>
                    ...
                    <Card shadow="sm" padding="lg" radius="md" withBorder>
                        <GroupIcon fontSize="large" className="text-green-500 mb-4"/>
                    ...
                    <Card shadow="sm" padding="lg" radius="md" withBorder>
                        <EmojiEventsIcon fontSize="large" className="text-yellow-500 mb-4"/>
